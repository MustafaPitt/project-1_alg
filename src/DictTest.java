...
public class DictTest
{
    public static void main(String [] args) throws IOException
    {
        ...
        Scanner boardFile = new Scanner((new FileInputStream("test3a.txt")));


        // TEST_MYCODE
        CrossWord mycross = new CrossWord(boardFile);
        System.out.println("testing the size " +mycross.size);
        mycross.printCrossWord();
...
//            D = new DLB();
 //       else
        ...
        for (int i= 0 ; i < mycross.scanBoard().size() ; i++){
            System.out.println("the length is  " + i + " " +mycross.scanBoard().get(i));
        }

//        String [] tests = {"abc", "abe", "abet", "abx", "ace", "acid", "hives",
//                "iodin", "inval", "zoo", "zool", "123", "a","b","c","z"};
